...
const tg: Dict = {
  ...
  'settings.timezone': '🌍 Минтақаи вақт: <b>{zone}</b> ({offset})',
  'settings.currency': '💰 Асъори ҳисобот: <b>{code}</b>',
  'settings.language': '🗣 Забон: <b>{name}</b>',
  ...
  'settings.timezoneSet': '🌍 Минтақаи вақт: <b>{city}</b> ({offset})\n\nАкнун «имрӯз», ҳафта ва моҳ аз рӯи он ҳисоб мешаванд.',
  ...
  'receipt.question': 'Дар чек ёфтам. Кадом маблағ харҷ аст?',
...
const en: Dict = {
  ...
  'settings.timezone': '🌍 Time zone: <b>{zone}</b> ({offset})',
  'settings.currency': '💰 Report currency: <b>{code}</b>',
  'settings.language': '🗣 Language: <b>{name}</b>',
  ...
  'receipt.question': 'Found these on the receipt. Which amount is the expense?',
